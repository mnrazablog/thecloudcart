...
$(document).ready(function() {
	...
	$('#grid-view').click(function() {
		...
		if (cols == 2) {
			...
			$('#content .product-layout:nth-child(4n+1)').attr('class', 'product-layout product-grid col-lg-3 col-md-6 col-sm-12 col-xs-12 first-item');
			$('#content .product-layout:nth-child(4n+4)').attr('class', 'product-layout product-grid col-lg-3 col-md-6 col-sm-12 col-xs-12 last-item');
		...
		if (document.documentElement.clientWidth <= 1200 && document.documentElement.clientWidth > 991) {
			$('#content .product-layout').attr('class', 'product-layout product-grid col-lg-3 col-md-4 col-sm-12 col-xs-12');
			$('#content .product-layout:nth-child(3n+1)').attr('class', 'product-layout product-grid col-lg-3 col-md-4 col-sm-12 col-xs-12 first-item');
			$('#content .product-layout:nth-child(3n+3)').attr('class', 'product-layout product-grid col-lg-3 col-md-4 col-sm-12 col-xs-12 last-item');
		}
		if (document.documentElement.clientWidth < 992 && document.documentElement.clientWidth > 767) {
			$('#content .product-layout').attr('class', 'product-layout product-grid col-lg-3 col-md-4 col-sm-6 col-xs-12');
			$('#content .product-layout:nth-child(2n+1)').attr('class', 'product-layout product-grid col-lg-3 col-md-4 col-sm-6 col-xs-12 first-item');
